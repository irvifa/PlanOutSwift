...
public protocol ReadableAssignment {
    ...
    */
    ...
    /* Get value from assignment, with default value.
        This method will return defaultValue if there is no assignment value with matching variable name, or if the assignment value cannot be typecasted to type `T`.
        - Parameter(s):
            - name: The variable name
